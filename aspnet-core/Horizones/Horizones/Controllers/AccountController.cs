...
namespace Horizones.Controllers
{
    public class AccountController : BaseAPIController
    {
        ...
        public async Task<ActionResult<UserDto>> Login(LoginDto loginDto)
        {
            ...
            //TODO: check flag true to lock out the user and check the framwork behaviour
        ...
        public async Task<ActionResult<UserDto>> Register(RegisterDto registerDto)
        {
            ...
            {
                return new BadRequestObjectResult(new ApiValidationErrorResponse{Errors = ["Email address is already in use"]});
            }
